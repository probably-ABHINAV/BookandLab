                  ...
                  <tr key={u.id} className="hover:bg-[var(--c2)] transition-colors group">
                    ...
                    <td className="p-6 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="w-10 h-10 rounded-[10px] border border-[var(--br)] flex items-center justify-center hover:bg-[var(--bg2)] text-[var(--dark)] transition-colors" title="Manage Preferences">
                          <Settings className="w-4 h-4" />
                        </button>
                        <button onClick={() => setDeleteId(u.id)} className="w-10 h-10 rounded-[10px] border border-[var(--red)] flex items-center justify-center hover:bg-red-50 text-[var(--red)] transition-colors" title="Deactivate User">
